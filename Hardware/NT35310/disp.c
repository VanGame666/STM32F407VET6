...
u16 LCD_ReadPoint(u16 x,u16 y)
{
    ...
    r = LCD_RD_DATA();          //ʵ��������ɫ
	r = (r & 0xFF00);
    g = (r & 0X00FF) << 8;               //���� 7796/5310/5510/7789, ��һ�ζ�ȡ����RG��ֵ,R��ǰ,G�ں�,��ռ8λ
    b = LCD_RD_DATA();

    return (((r >> 11) << 11) | (g >> 6) | (b >> 11));  // 5310/5510/7789 ��Ҫ��ʽת��һ��
}
...
{ 	  
  ...
  //LCD��λ
    ...
    //��ʼ������Ժ�,����
	  if(lcddev.id==0X7796||lcddev.id==0x7789||lcddev.id==0x5310||lcddev.id==0X5510)//������⼸��IC,������WRʱ��Ϊ���
    {
        //��������дʱ����ƼĴ�����ʱ��
