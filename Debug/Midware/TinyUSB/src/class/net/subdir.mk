...
C_SRCS += \
../Midware/TinyUSB/src/class/net/ecm_rndis_device.c \
../Midware/TinyUSB/src/class/net/ncm_device.c 

OBJS += \
./Midware/TinyUSB/src/class/net/ecm_rndis_device.o \
./Midware/TinyUSB/src/class/net/ncm_device.o 

C_DEPS += \
./Midware/TinyUSB/src/class/net/ecm_rndis_device.d \
./Midware/TinyUSB/src/class/net/ncm_device.d 


# Each subdirectory must supply rules for building sources it contributes
Midware/TinyUSB/src/class/net/%.o Midware/TinyUSB/src/class/net/%.su Midware/TinyUSB/src/class/net/%.cyclo: ../Midware/TinyUSB/src/class/net/%.c Midware/TinyUSB/src/class/net/subdir.mk
...
clean: clean-Midware-2f-TinyUSB-2f-src-2f-class-2f-net

clean-Midware-2f-TinyUSB-2f-src-2f-class-2f-net:
	-$(RM) ./Midware/TinyUSB/src/class/net/ecm_rndis_device.cyclo ./Midware/TinyUSB/src/class/net/ecm_rndis_device.d ./Midware/TinyUSB/src/class/net/ecm_rndis_device.o ./Midware/TinyUSB/src/class/net/ecm_rndis_device.su ./Midware/TinyUSB/src/class/net/ncm_device.cyclo ./Midware/TinyUSB/src/class/net/ncm_device.d ./Midware/TinyUSB/src/class/net/ncm_device.o ./Midware/TinyUSB/src/class/net/ncm_device.su

.PHONY: clean-Midware-2f-TinyUSB-2f-src-2f-class-2f-net
