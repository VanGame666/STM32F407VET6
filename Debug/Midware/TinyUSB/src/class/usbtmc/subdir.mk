...
C_SRCS += \
../Midware/TinyUSB/src/class/usbtmc/usbtmc_device.c 

OBJS += \
./Midware/TinyUSB/src/class/usbtmc/usbtmc_device.o 

C_DEPS += \
./Midware/TinyUSB/src/class/usbtmc/usbtmc_device.d 


# Each subdirectory must supply rules for building sources it contributes
Midware/TinyUSB/src/class/usbtmc/%.o Midware/TinyUSB/src/class/usbtmc/%.su Midware/TinyUSB/src/class/usbtmc/%.cyclo: ../Midware/TinyUSB/src/class/usbtmc/%.c Midware/TinyUSB/src/class/usbtmc/subdir.mk
...
clean: clean-Midware-2f-TinyUSB-2f-src-2f-class-2f-usbtmc

clean-Midware-2f-TinyUSB-2f-src-2f-class-2f-usbtmc:
	-$(RM) ./Midware/TinyUSB/src/class/usbtmc/usbtmc_device.cyclo ./Midware/TinyUSB/src/class/usbtmc/usbtmc_device.d ./Midware/TinyUSB/src/class/usbtmc/usbtmc_device.o ./Midware/TinyUSB/src/class/usbtmc/usbtmc_device.su

.PHONY: clean-Midware-2f-TinyUSB-2f-src-2f-class-2f-usbtmc
