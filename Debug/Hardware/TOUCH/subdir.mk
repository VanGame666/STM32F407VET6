...
OBJS += \
./Hardware/TOUCH/ctiic.o \
./Hardware/TOUCH/touch.o 

C_DEPS += \
./Hardware/TOUCH/ctiic.d \
./Hardware/TOUCH/touch.d 


# Each subdirectory must supply rules for building sources it contributes
Hardware/TOUCH/%.o Hardware/TOUCH/%.su Hardware/TOUCH/%.cyclo: ../Hardware/TOUCH/%.c Hardware/TOUCH/subdir.mk
...
clean: clean-Hardware-2f-TOUCH

clean-Hardware-2f-TOUCH:
	-$(RM) ./Hardware/TOUCH/ctiic.cyclo ./Hardware/TOUCH/ctiic.d ./Hardware/TOUCH/ctiic.o ./Hardware/TOUCH/ctiic.su ./Hardware/TOUCH/touch.cyclo ./Hardware/TOUCH/touch.d ./Hardware/TOUCH/touch.o ./Hardware/TOUCH/touch.su

.PHONY: clean-Hardware-2f-TOUCH
