...
#define		I2C1_Delay       	for(int i = 1000; i != 0; i--)
#define		I2C1_SDA_READ   	HAL_GPIO_ReadPin(I2C1_GPIO_PORT,I2C1_PIN_SDA)

#define		I2C1_SCL_H			HAL_GPIO_WritePin(I2C1_GPIO_PORT,I2C1_PIN_SCL,GPIO_PIN_SET);I2C1_Delay
#define		I2C1_SCL_L			HAL_GPIO_WritePin(I2C1_GPIO_PORT,I2C1_PIN_SCL,GPIO_PIN_RESET);I2C1_Delay
#define		I2C1_SDA_H			HAL_GPIO_WritePin(I2C1_GPIO_PORT,I2C1_PIN_SDA,GPIO_PIN_SET);I2C1_Delay
#define		I2C1_SDA_L			HAL_GPIO_WritePin(I2C1_GPIO_PORT,I2C1_PIN_SDA,GPIO_PIN_RESET);I2C1_Delay
...
/* Clock and data line control */
#define		I2C2_Delay       	for(int i = 1000; i != 0; i--)
