...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_chart_set_div_line_count(ui->screen_1_chart_1, 10, 10);
    lv_chart_set_point_count(ui->screen_1_chart_1, 11);
    lv_chart_set_range(ui->screen_1_chart_1, LV_CHART_AXIS_PRIMARY_Y, 0, 123);
    lv_chart_set_axis_tick(ui->screen_1_chart_1, LV_CHART_AXIS_PRIMARY_Y, 1, 10, 10, 1, false, 40);
    lv_chart_set_range(ui->screen_1_chart_1, LV_CHART_AXIS_SECONDARY_Y, 0, 111);
    lv_chart_set_axis_tick(ui->screen_1_chart_1, LV_CHART_AXIS_PRIMARY_X, 10, 1, 10, 1, false, 40);
    lv_chart_set_zoom_x(ui->screen_1_chart_1, 255);
    lv_chart_set_zoom_y(ui->screen_1_chart_1, 255);
    ...
    lv_chart_set_next_value(ui->screen_1_chart_1, ui->screen_1_chart_1_0, 35);
    lv_chart_set_next_value(ui->screen_1_chart_1, ui->screen_1_chart_1_0, 06);
    lv_chart_set_next_value(ui->screen_1_chart_1, ui->screen_1_chart_1_0, 80);
    lv_chart_set_next_value(ui->screen_1_chart_1, ui->screen_1_chart_1_0, 04);
    lv_chart_set_next_value(ui->screen_1_chart_1, ui->screen_1_chart_1_0, 40);
    lv_chart_set_next_value(ui->screen_1_chart_1, ui->screen_1_chart_1_0, 0);
#endif
    lv_obj_set_pos(ui->screen_1_chart_1, 47, 55);
    lv_obj_set_size(ui->screen_1_chart_1, 232, 203);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_chart_1, 189, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1_chart_1, lv_color_hex(0x098D6B), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_table_1, 28, 305);
